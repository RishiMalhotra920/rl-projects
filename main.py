...
def main(isRender=False, env_name='CliffWalking'):
    if env_name == 'CliffWalking':
        ...
        td_agent = TDAgent(env, states, actions, isRender)
        qlearning_rewards = td_agent.train(
            algorithm="qlearning", num_episodes=1000, episode_length=200, n=5, gamma=0.99, alpha=0.1, epsilon=0.2, epsilon_decay=0.99, isRender=isRender)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', type=str,
                        default='CliffWalking', help='Environment name')
    # how do i call this with the env arg
    #
    args = parser.parse_args()

    main(isRender=args.render, env_name=args.env)
